...
Error.pageRequestManagerTimeout = function Error$pageRequestManagerTimeout() {
    /// <returns></returns>
...
Error.pageRequestManagerServerError = function Error$pageRequestManagerServerError(httpStatusCode, message) {
    /// <param name="httpStatusCode" type="Number"></param>
    /// <param name="message" type="String" optional="true" mayBeNull="true"></param>
    /// <returns></returns>
    var e = Function._validateParams(arguments, [
        {name: "httpStatusCode", type: Number},
...
Error.pageRequestManagerParserError = function Error$pageRequestManagerParserError(parserErrorMessage) {
    /// <param name="parserErrorMessage" type="String"></param>
    /// <returns></returns>
    var e = Function._validateParams(arguments, [
        {name: "parserErrorMessage", type: String}
    ]);
    if (e) throw e;
...
Sys.WebForms.EndRequestEventArgs = function Sys$WebForms$EndRequestEventArgs(error, dataItems, response) {
    ...
    this._error = error;
    this._dataItems = dataItems ? dataItems : {};
...
Sys.WebForms.PageRequestManager = function Sys$WebForms$PageRequestManager() {
    ...
    function Sys$WebForms$PageRequestManager$_isScriptLoaded(scriptSrc) {
        
                                
        var dummyScript = document.createElement('script');
        dummyScript.src = scriptSrc;

        return Array.contains(this._referencedScripts, dummyScript.src);
    }
    ...
    function Sys$WebForms$PageRequestManager$_onFormSubmitCompleted(sender, eventArgs) {
        ...
        if (sender.get_timedOut()) {
            this._endPostBack(Error.pageRequestManagerTimeout(), sender);
            return;
        }
        ...
        var delta = [];
            ...
            this._endPostBack(Error.pageRequestManagerServerError(sender.get_statusCode()), sender);
            return;
        }
        ...
        while (replyIndex < reply.length) {
            ...
            this._endPostBack(Error.pageRequestManagerParserError(String.format(Sys.WebForms.Res.PRM_ParserErrorDetails, parserErrorDetails)), sender);
            return;
        }
        ...
        var asyncPostBackControlIDsNode, postBackControlIDsNode,
            ...
            switch (deltaNode.type) {
                ...
                case "pageRedirect":
                    ...
                    return;
                case "error":
                                        this._endPostBack(Error.pageRequestManagerServerError(Number.parse(deltaNode.id), deltaNode.content), sender);
                    return;
                case "pageTitle":
                ...
                case "focus":
                    ...
                    break;
                default:
                                        this._endPostBack(Error.pageRequestManagerParserError(String.format(Sys.WebForms.Res.PRM_UnknownToken, deltaNode.type)), sender);
                    return;
            }
        }
        ...
        for (i = existingScripts.length - 1; i >= 0; i--) {
            ...
            if (scriptSrc.length) {
                if (!Array.contains(this._referencedScripts, scriptSrc)) {
                    Array.add(this._referencedScripts, scriptSrc);
                }
            }
        }
            ...
            switch (scriptBlockType) {
                ...
                case "ScriptContentWithTags":
                    ...
                    eval("scriptTagAttributes = " + scriptBlockNodes[i].content);
                                        ...
                                        if (scriptTagAttributes.src && this._isScriptLoaded(scriptTagAttributes.src)) {
                        continue;
                    }
                    ...
                    break;
                case "ScriptPath":
                                        if (this._isScriptLoaded(scriptBlockNodes[i].content)) {
                        continue;
                    }
...
Sys.WebForms.PageRequestManager.prototype = {
    ...
    _isScriptLoaded: Sys$WebForms$PageRequestManager$_isScriptLoaded,
