...
/**
 * @author Jonathan Gardern
 * @author Beau Hartshorne
 * @author Bob Ippolito
 * @projectDescription Module for event handling.
 * @namespace MochiKit.Signal MochiKit.Signal namespace for event handling functionality.
 * @version  1.3.1
 */
