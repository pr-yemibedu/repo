...
/**
 * @author Bob Ippolito
 * @projectDescription Contains visual effects and support functions for visual effects.
 * @namespace MochiKit.Visual MochiKit.Visual namespace for visual effects such as rounding
 * corners and rounding elements.
 * @version  1.3.1
 */
