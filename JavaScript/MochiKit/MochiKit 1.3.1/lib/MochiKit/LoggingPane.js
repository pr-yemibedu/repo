...
/**
 * @author Bob Ippolito
 * @projectDescription Provides a browser-based interactive logging pane for MochiKit.Logging output.
 * @namespace MochiKit.LoggingPane MochiKit.LoggingPane namespace that provides a 
 * browser-based interactive logging pane for MochiKit.Logging output.
 * @version 1.3.1 
 */
