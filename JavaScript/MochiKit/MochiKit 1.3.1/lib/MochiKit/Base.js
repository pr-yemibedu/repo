...
/**
 * @author Bob Ippolito
 * @projectDescription	Provides functional programming and comparison functions.
 * @namespace MochiKit.Base MochiKit.Base namespace that provides utility and comparison
 * functions.
 * @version 1.3.1
 */
