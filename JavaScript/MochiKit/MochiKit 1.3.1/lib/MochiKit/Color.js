...
/**
 * @author Bob Ippolito
 * @projectDescription	Abstraction for handling colors and strings that represent colors.
 * @namespace MochiKit.Color MochiKit.Color namespace that provides functions for creating colors
 * and converting strings to colors, converting between color formats, and other similar
 * functionality.
 * @version 1.3.1
 */
