// SAVE.cpp : Defines the entry point for the application.
//
					...
					int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_SAVE);
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
    ...
    wc.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SAVE));
    wc.hCursor			= 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	LoadString(hInstance, IDC_SAVE, szWindowClass, MAX_LOADSTRING);
