...
class Notepad extends JPanel implements ActionListener{
	...
	urlString = new JTextField();
	viewUrlButton = new JButton("View");
	viewUrlButton.addActionListener(this);
	urlPanel.setLayout(new BorderLayout());	
	urlPanel.add("West", new JLabel("URL:"));
	urlPanel.add("Center", urlString);
	urlPanel.add("East", viewUrlButton);
	
	menuItems = new Hashtable();
	menubar = createMenubar();
	
	topPanel.add("North", menubar);
	topPanel.add("Center", createToolbar());
    ...
    private JTextField urlString;
    private JButton viewUrlButton;
