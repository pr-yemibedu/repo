...
BOOL cADOCE::GetRecordSetInterface()
{
	...
	_Connection	*Conn1;		// new in ADOCE3.0
	VARIANT			varConn1;	
	BOOL			bADOCE3=FALSE;
	IADOCERecordset		*Rs1;	
	IADOCEFields			*Fields;
				...
				LockTypeEnum LockType, long lOptions)
{
	...
	COleVariant vConnection;	// Not used in ADOCE 1.0
