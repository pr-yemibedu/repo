========================================================================
     Microsoft Foundation Class Library for Windows CE: IComp
========================================================================


AppWizard has created this IComp application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your IComp application.

IComp.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CICompApp application class.
...
res\IComp.ico
    ...
    icon is included by the main resource file IComp.rc.
...
ICompDoc.h, ICompDoc.cpp - the document
    These files contain your CICompDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CICompDoc::Serialize).

ICompView.h, ICompView.cpp - the view of the document
    These files contain your CICompView class.
    CICompView objects are used to view CICompDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named IComp.pch and a precompiled types file named StdAfx.obj.
